...
- **[Mới hoàn thành]** Tích hợp tính năng **Bulk Action Bar** và API CRUD cơ bản.
- **[Mới hoàn thành]** Chuẩn hóa giao diện **Modal Header**: Thiết kế Brand-boxed icon mới cho module Hosting.
- **[Mới hoàn thành]** Đồng bộ hệ thống **Dropdown Select**: Sử dụng giao diện premium đồng bộ toàn Dashboard.
